...
if($Target.Equals("Release")) {
    ...
    New-Item -Type Directory -Path "$PackagePath\GooderRecycling" -Force
    Copy-Item -Path "$TargetPath\$TargetAssembly" -Destination "$PackagePath\GooderRecycling\$TargetAssembly" -Force
